...
user_prompt = input("Enter the user prompt (If '', example user input will be launched): ")
...
for i in range(agent_number):
    agent = Agent(
        ...
        # You can specify the a model by adding attributeso of model="gpt-3.5-turbo",
    )
    agents.append(agent)
